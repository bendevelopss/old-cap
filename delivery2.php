...
<link rel="stylesheet" href="http://localhost/xampp/capstone/font-awesome-4.6.3/css/font-awesome.min.css">
  ...
  <script src="http://localhost/xampp/capstone/DataTables/js/jquery-1.12.4.js"></script>
  <script src="http://localhost/xampp/capstone/DataTables/js/dataTables.select.min.js"></script>
  <script src="http://localhost/xampp/capstone/DataTables/js/jquery.dataTables.min.js"></script>
...
?>
<!--Input-->
<label style="margin-left:-1000px;">Delivery ID:</label>
...
<label style="margin-left:-1000px;">Supplier:</label>
    <input class="w3-input w3-border" type="text" placeholder="Company" name="comp" id="comp" style="height:33px; width: 20%; margin-left:100px; " value="<?php echo ''.$supplier.''; ?>" readonly>
...
<tbody>';
    ...
    {
  ?>    <tr>
      <form method="post" action="delivery2.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>&employee=<?php echo $scname?>&materialreq=<?php echo $quote_no?>">
      ...
      <td><?php  echo $product_array[$key]["quantity"];?>
         <input type="text" hidden id="qty2_<?php echo $product_array[$key]["code"]; ?>" class="qty2" name="quantity2" value="<?php echo $product_array[$key]["quantity"]; ?>" size="2"/></td>
...
<form method="post" action="delivery2.php?id=<?php echo ''.$_GET['id'].''?>&scname=<?php echo ''.$_GET['scname'].''?>&prepared=<?php echo ''.$_GET['prepared'].''?>">
<?php
