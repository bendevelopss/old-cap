...
(function($){
    $.fn.smartCart = function(options) {
        ...
        return this.each(function() {
                ...
                var attrProductDesc = "pdesc"; // Product Description attribute   
                ...
                var elmCartHeaderTitle5 = $('<label>Action</label>').addClass("scCartTitle scCartTitle5");
                ...
                function addCartItemDisplay(objProd,Quantity){
                    ...
                    var pDesc = $(objProd).attr(attrProductDesc);
