...
<!--Input-->
<label style="margin-left:-1000px;">Material Requisition ID:</label>
...
<label style="margin-left:-1000px;">Customer:</label>
    <input class="w3-input w3-border" type="text" placeholder="Company" name="comp" id="comp" style="height:33px; width: 20%; margin-left:100px; " value="<?php echo ''.$cust.''; ?>" readonly>
...
<br>
<input type="hidden" name="samp" id="samp" style="height:33px; width: 20%; margin-left:100px; " value="<?php echo ''.$_GET['scname'].''; ?>">
...
<tbody>';
  ...
  ?>    <tr>
      ...
      <td><?php echo $product_array[$key]["unit_measurement"];?> <?php echo $product_array[$key]["abbre"];?></strong></td>

      <td><?php echo $product_array[$key]["quantity_remaining"];?>
          <input type="number" hidden id="qty2_<?php echo $product_array[$key]["code"]; ?>" class="qty2" name="quantity2" value="<?php echo $product_array[$key]["quantity"]; ?>" size="2"/></td>

      </td>
      <td><?php echo $product_array[$key]["quantity_available"];?>
         <input type="number" hidden id="qty1_<?php echo $product_array[$key]["code"]; ?>" class="qty1" name="quantity1" value="<?php echo $product_array[$key]["quantity_available"]; ?>" size="2"/>
...
<form method="post" action="materialrequisition3.php?id=<?php echo ''.$_GET['id'].''?>&scname=<?php echo ''.$_GET['scname'].''?>&prepared=<?php echo ''.$_GET['prepared'].''?>">
<?php
...
<!--Input-->
    <script>
    function done() {
    window.location.href="materialrequisition1.php";
    }
    </script>
