...
?>
<div class="w3-half">
<label style="margin-left:-350px;">Pullout ID:</label>
...
<div class="container" style="width:98%; margin-left: 10px;">
  ...
  <table class="table-bordered w3-table w3-bordered w3-striped w3-border w3-hoverable" id="tableko" name="tableko" >
    ...
    while($row = $result->fetch_assoc())
      { 
      echo'<tr>';
      echo'<td>'.ucfirst($row['req']).'</td>';
        echo'<td>'.ucfirst($row['cust']).' </td>';
        echo'<td>'.ucfirst($row['proj']).'</td>';
        echo'<td>'.ucfirst($row['date']).'</td>';
        echo'<td style="text-align:center;">';
        echo'<button type="button" name="btnNext" onclick="return myFunctions();" class="w3-btn w3-green w3-border w3-round-large"><a href="pullout2.php?id='.$hell.'&scname='.$row['req'].'&prepared='.ucfirst($lastname2).', '.ucfirst($firstname2).' '.strtoupper($middlename2[0]).'" style="color:White; ">Transact</a> </a></button> ';
        }
      echo'</tr>';
     echo' 
    </tbody>
...
<div class="w3-row-padding">
  <div class="w3-third">
    <label style="margin-left:-155px;">Verified by:</label>
...
<!--Buttons-->
<br>
<button type="button" name="btnNext" onclick="return myFunctions();" class="w3-btn w3-blue w3-border w3-border-red w3-round-large">Accept</a></button>
<button type="submit" name="btnDec" onclick="return done();" class="w3-btn w3-red w3-border w3-border-red w3-round-large">Decline</a></button>
<br></br><br></br>
<!--Left Body-->
